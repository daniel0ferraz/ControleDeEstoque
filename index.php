...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" integrity="sha384-HSMxcRTRxnN+Bdg0JdbxYKrThecOKuH5zCYotlSAcp1+c8xmyTe9GYg1l9a69psu" crossorigin="anonymous"><link rel="stylesheet" href="bootstrap-3.4.1-dist/css/bootstrap.min.css">
                            ...
                            foreach ($sql->fetchAll() as $entrada) {
                                ...
                                <tr>
                                  <td><?php echo $entrada['CODIGO']; ?></td>
                                    ...
                                    <td>
                                    <?php echo '<a class="btn btn-success "href="editar.php?id='.$entrada['CODIGO'] ;?>'"><i class="far fa-edit"></i></a>
                                    <?php echo '<a class="btn btn-danger "href="deletar.php?id='.$entrada['CODIGO'] ;?>'"><i class="far fa-trash-alt"></i></a>
                                   </td>
                                </tr>
                        <?php
                              }
